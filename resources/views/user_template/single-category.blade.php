...
@section('page_title')
{{ $category->category_name }} | Nice Day
@endsection
@section('content')
                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                @if (Route::currentRouteNamed('user.singlecategory') && Request::route('slug') === $category->slug)
                                                <li><a href="{{ route('user.singlecategory', $category->slug) }}" style="color:#111111">{{ $category->category_name }} ({{ $category->product_count }})</a></li>
                                                @else
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="shop__product__option__left">
                                <p>Showing {{ $allproducts->count() }} of {{ $allproducts->count() }} results</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
